...
def train():
    ...
    with tf.Graph().as_default(), tf.device('/cpu:0'):
        ...
        num_batches_per_epoch = (fer2013.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN /
                               FLAGS.batch_size)
        decay_steps = int(num_batches_per_epoch * fer2013.NUM_EPOCHS_PER_DECAY)
        
        # Decay the learning rate exponentially based on the number of steps.
        lr = tf.train.exponential_decay(fer2013.INITIAL_LEARNING_RATE,
                                      global_step,
                                      decay_steps,
                                      fer2013.LEARNING_RATE_DECAY_FACTOR,
                                      staircase=True)
        ...
        variable_averages = tf.train.ExponentialMovingAverage(
            fer2013.MOVING_AVERAGE_DECAY, global_step)
        ...
        summary_writer = tf.train.summary.FileWriter(FLAGS.train_dir,
